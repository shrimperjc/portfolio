    ...
    <section class="relative md:py-24 py-16 bg-gray-50 dark:bg-slate-800" id="service">
            <div class="container">
                <div class="grid grid-cols-1 pb-8 text-center">
                    ...
                    <!-- <p class="text-slate-400 max-w-xl mx-auto text-[15px]">I'm a Front End Web Developer and Systems Developer with over 13 years of
                        experience in all stages of front end development</p> -->
                </div><!--end grid-->
                ...
                services: [
                    {
                        ...
                        desc: 'Front End Website Design'
                    },
                    {
                        icon: 'layout',
                        name: 'CMS Website Build and Content Updates',
