     ...
     <section class="relative md:py-24 py-16" id="contact">
            <div class="container">
                <div class="grid grid-cols-1 pb-8 text-center">
                    ...
                    <p class="text-slate-400 max-w-xl mx-auto text-[15px]">For any and all questions concerning a project or any enquiry, please just drop me an email by using the e-mail address below or fill out the contact form at the bottom of this page.
                        ...
                        <div class="lg:ms-8">
                            <div class="flex">
                                ...
                                <div class="flex-1 ms-6">
                                    ...
                                    <a href="tel:+152534-468-854" class="text-slate-400 text-[15px]">+44 7593 606860</a>
                                </div>
                            </div>
                            ...
                            <div class="flex mt-4">
                                ...
                                <div class="flex-1 ms-6">
                                    ...
                                    <a href="mailto:contact@example.com" class="text-slate-400 text-[15px]">jcoman1975@icloud.com</a>
                                </div>
                            </div>
                            ...
                            <div class="flex mt-4">
                                ...
                                <div class="flex-1 ms-6">
                                    ...
                                    <p class="text-slate-400 text-[15px] mb-2">Essex, UK</p>
                                </div>
                            </div>
                        </div>
                    </div>
