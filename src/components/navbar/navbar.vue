            ...
            <div class="container flex flex-wrap items-center justify-between">
                <router-link to="/" v-if="navLight" class="navbar-brand md:me-8" >
                    <span class="inline-block dark:hidden">
                        <img src="../../assets/images/jctranslogo.png" class="l-dark" alt="">
                        <img src="../../assets/images/jctranslogo.png" class="l-light" alt="">
                    </span>
                    <img src="../../assets/images/jctranslogo.png" class="hidden dark:inline-block" alt="">
                </router-link>

                <router-link to="/" v-else  class="navbar-brand md:me-8" >
                    <img src="../../assets/images/jctranslogo.png" class="inline-block dark:hidden" alt="">
                    <img src="../../assets/images/jctranslogo.png" class="hidden dark:inline-block" alt="">
                </router-link>
